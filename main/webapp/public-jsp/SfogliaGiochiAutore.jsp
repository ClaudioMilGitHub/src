...
<body>
	...
	<%List<Gioco> listaGiochi =  (List<Gioco>) request.getAttribute("listaPublisher");%>
	<%Utente autore = (Utente) request.getAttribute("autore"); %>
...
<div class="container-fluid min-vh-100 d-flex flex-column">
		...
		<div class="row content-cards flex-grow-1" id="row-cards">
			...
			<%} else {%>
				<p class="text-center fs-1" style = "color:#ffff;"><%=autore.getNome()%></p>
			<%}%>
