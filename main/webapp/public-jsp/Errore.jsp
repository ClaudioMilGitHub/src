...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/CSS/ErroreStyle.css">
    <title>ERRORE</title>
</head>
<body>
    <div class="container-fluid">
        ...
        <div class="row ">
            ...
            <div class="col-lg-6">
                <div id="box-1">
                    <div id="box-small">
                        <h2 class="mt-5 text-danger">Si è verificato un errore</h2>
                        <p>Qualcosa è andato storto. Riprova o contatta il supporto.</p>
                        <a href="<%=request.getContextPath()%>/public-jsp/PaginaLogin.jsp" class="btn btn-primary">Torna alla Home</a>
                    </div>
            </div> 
