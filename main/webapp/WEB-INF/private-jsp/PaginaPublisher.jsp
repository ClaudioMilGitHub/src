...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/Pagina_Publisher.css">
		...
		<section>
				...
				<div class="col-lg-3">
					<div class="card mb-3">
						<div class="card-body text-center"
							style="background-color: #536f86;">
							<img
								src="https://static.miraheze.org/nonciclopediawiki/9/9e/Richard_Benson_urla_2.jpg"
                        ...
                        %>
							...
							<p class="text-muted mb-4">
                         	...
                         	%>
								...
								<a href="https://<%=utenteLoggato.getSitoWeb()%>"><%=utenteLoggato.getSitoWeb()%></a>
			...
			<div class="col-lg-12 mb-3">
				<div class="d-grid gap-2" style="background-color: #171a21;">
					<div id="btn2">
						<a href="<%=request.getContextPath()%>/AddGameLogicServlet"><button
								class="btn btn-primario" type="button"
								style="background-color: #536f86;">Aggiungi il tuo
								gioco</button></a> <a
							href="<%=request.getContextPath()%>/UpdateGameLogicServlet"><button
								class="btn btn-secondario" type="button"
								style="background-color: #2c3b47;">Aggiorna il tuo
								gioco</button></a> <a
							href="<%=request.getContextPath()%>/DeleteGameLogicServlet"><button
								class="btn btn-terziario" type="button"
								style="background-color: #171a21;">Rimuovi il tuo gioco</button></a>
					</div>
				</div>
			</div>
