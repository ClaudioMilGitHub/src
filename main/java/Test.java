...
//		BusinessLogic.addGenere("FPS");
		...
		//Aggiungi Recensione al database
//		BusinessLogic.addRecensione("Recensione di prova", 1, 60);
//		BusinessLogic.addRecensione("Recensione di prova", 6, 60);
		
//		List<Recensione> recensioni = BusinessLogic.getAllRecensioniByGame(60);
//		
